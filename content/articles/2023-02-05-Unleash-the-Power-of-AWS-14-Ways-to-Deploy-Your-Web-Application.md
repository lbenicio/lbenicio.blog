...
02. Elastic Beanstalk: Elastic Beanstalk is a fully managed service that takes care of the deployment, scaling, and management of your web application. Simply upload your application and AWS will handle the rest.

03. AWS Lambda: AWS Lambda is a serverless computing platform that lets you run your code without having to manage any infrastructure. Simply upload your code, set triggers, and AWS will automatically run your code when those triggers are activated.

04. EC2 Container Service (ECS): ECS is a fully managed container management service that makes it easy to deploy, run, and scale Docker containers.

05. EC2 Container Registry (ECR): ECR is a fully managed Docker container registry that makes it easy to store, manage, and deploy Docker images.

06. AWS CloudFormation: CloudFormation is a service that helps you model and set up your AWS resources, so you can spend less time managing infrastructure and more time focusing on your application.

07. Elastic Load Balancer (ELB): ELB is a fully managed load balancer that automatically distributes incoming traffic across multiple targets, such as EC2 instances, containers, and IP addresses.

08. Auto Scaling: Auto Scaling automatically adjusts your application's capacity to meet demand, so you can maintain performance and availability.

09. Amazon Lightsail: Lightsail is a fully managed service that makes it easy to launch and manage web applications, including WordPress, Magento, and Node.js.
