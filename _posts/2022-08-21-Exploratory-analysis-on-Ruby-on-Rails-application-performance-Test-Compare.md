...
![Completed requests time with 4 cores, 26624mb RAM for 60 seconds.](/assets/imgs/1-t.png){:class="img-fluid"}

![Completed requests time with 4 cores, 26624mb RAM for 60 seconds.](/assets/imgs/2-t.png){:class="img-fluid"}
...
![Completed requests time with 8 cores, 16384mb RAM for 60 seconds.](/assets/imgs/5-t.png){:class="img-fluid"}

![Completed requests time with 8 cores, 26624mb RAM for 60 seconds.](/assets/imgs/6-t.png){:class="img-fluid"}
...
![Standard Deviation with 8 cores, 8192mb RAM for 60 seconds.](/assets/imgs/7-t.png){:class="img-fluid"}

![Standard Deviation with 8 cores, 16384mb RAM for 60 seconds.](/assets/imgs/8-t.png){:class="img-fluid"}
...
![Standard Deviation with 4 cores, 26624mb RAM for 60 seconds.](/assets/imgs/9-t.png){:class="img-fluid"}

![Standard Deviation with 4 cores, 26624mb RAM for 60 seconds.](/assets/imgs/10-t.png){:class="img-fluid"}
...
![Quartiles distributions for 50, 75, 95, and 99.](/assets/imgs/11-t.png){:class="img-fluid"}

![Quartile distributions for 50, 75, and 95.](/assets/imgs/12-t.png){:class="img-fluid"}
...
![Quartiles distributions for 50, and 75.](/assets/imgs/13-t.png){:class="img-fluid"}
